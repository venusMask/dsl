...
public class DslLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FIELD_TAKE", "LP", "RP", "EQ", "NE", "CONTAINS", "NOTCONTAINS", "IN", 
			"NOT", "AND", "OR", "SEMICOLON", "STRING_PARENS_CN", "ID", "LETTER", 
			"DIGIT", "STRING", "STRING_SQUARE_BRACKETS", "STRING_SINGLE_QUOTES", 
			"STRING_DOUBLE_QUOTES", "STRING_DOUBLE_QUOTES_CN", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
